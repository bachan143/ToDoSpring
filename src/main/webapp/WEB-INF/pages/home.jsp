		...
		<div class="row mt-5">
			...
			<div class="col-md-10">
				  ...
				  <c:if test="${page=='add'}">
				     ...
				     <form:form action="saveTodo" method="post" 
				     modelAttribute="todo">
				     
				        <div class="form-group">
				            <form:input path="todoTitle" 
				            class="form-control" placeholder="Enter the Todo Title"/>
				        </div>
				        <div class="form-group">
				            <form:textarea path="todoContent" 
				            class="form-control" placeholder="Enter the Todo Content" cssStyle="height:200px"/>
				        </div>
